...
class AdminPostController extends AdminbaseController {
	...
	function add(){
   	   ...
   	   //$terms = sp_get_terms("where:taxonomy='article';order:listorder asc");
       //$this->terms_model->where($where)->order(array("listorder"=>"asc"))->select();
	...
	private function _getTree(){
		...
		$result = sp_get_terms("where:taxonomy='article';order:listorder asc");
