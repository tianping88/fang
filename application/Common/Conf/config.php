...
//数据字典配置信息
if(file_exists("data/conf/data.php")){
		$data_config=include "data/conf/data.php";
}else{
    $data_config=array();
}
$configs= array(
		...
		'MODULE_ALLOW_LIST'  => array('Admin','Portal','Asset','Api','User','Comment','Jiazheng','ChinaCity'),
 		'TMPL_DETECT_THEME'     => false,       // 自动侦测模板主题
 		'TMPL_TEMPLATE_SUFFIX'  => '.html',     // 默认模板文件后缀
		'DEFAULT_MODULE'        =>  'Jiazheng',  // 默认模块
        ...
        'SMSOPTION'=>array(
            'accountsid'=>'187676bf78327f9cb4bff0e0abe072ed',
            'token'     =>'d114a05736652e3aa045ae0d87bb5ee1',
            'appid'     =>'e9268016ec3e4a2bb2c7d60b4994b6dc',
            'templateid'=>'23504',
...
return  array_merge($configs,$db,$runtime_config,$data_config);//这个顺序有问题
