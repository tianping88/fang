...
<link href="/fang/statics/simpleboot/themes/<?php echo C('SP_ADMIN_STYLE');?>/theme.min.css?v=20160415" rel="stylesheet">
...
<![endif]-->
<link rel="stylesheet" href="/fang/statics/simpleboot/themes/<?php echo C('SP_ADMIN_STYLE');?>/simplebootadminindex.min.css?">
<!--[if lte IE 8]>
	<link rel="stylesheet" href="/fang/statics/simpleboot/css/simplebootadminindex-ie.css?" />
<![endif]-->
<style>
...
<body style="min-width:900px;" screen_capture_injected="true">
	...
	<nav class="navbar" style="background-color:#1fa67a;">
		
			<div class="container-fluid">
				<div class="navbar-header">
                    <a href="/fang/index.php?g=admin&m=index&a=index" class="navbar-brand"> 
    				
    						永川租房网后台
    				
    				</a>
                </div>
				<div class="nav_shortcuts navbar-left" >
					
					<a class="btn btn-small btn-warning" href="/fang/" title="前台首页" target="_blank">
				...
				<ul class="nav simplewind-nav navbar-right">
					<li class="light-blue">
						<a data-toggle="dropdown" href="#" class="dropdown-toggle">
							<img class="nav-user-photo" src="/fang/statics/images/icon/logo-18.png" alt="<?php echo ($admin["user_login"]); ?>">
	...
	<script src="/fang/statics/js/jquery.js"></script>
	...
	<script src="/fang/tpl_admin/simpleboot/assets/js/index.js"></script>
